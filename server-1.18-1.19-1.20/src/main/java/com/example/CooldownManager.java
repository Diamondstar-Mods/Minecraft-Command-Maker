...
public class CooldownManager {
     ...
     */
    public static boolean checkCooldown(String alias, ServerCommandSource source) {
     ...
     */
    public static long getRemaining(String alias, ServerPlayerEntity player) {
     ...
     */
    public static long getRemainingByName(String alias, String playerName, ServerCommandSource source) {
    ...
    private static void sendCooldownMessage(ServerCommandSource source, CooldownConfig cfg, long remaining) {

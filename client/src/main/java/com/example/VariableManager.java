...
public class VariableManager {
    ...
    public static String substituteVariables(String command, MinecraftClient client) {
    ...
    public static void setVariable(MinecraftClient client, String key, String value) {
        if (client.player == null) return;
        UUID uuid = client.player.getUuid();
        playerVariables.computeIfAbsent(uuid, k -> new HashMap<>()).put(key, value);
    }

    public static String getVariable(MinecraftClient client, String key) {
